...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/nsemclaw/openclaw/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.NSEMCLAW_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.nsemclaw/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: NsemclawConfig = {
    ...params.cfg,
