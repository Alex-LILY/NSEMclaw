...
vi.mock("./nsemclaw-root.js", () => ({
  resolveNsemclawPackageRoot: vi.fn(async () => null),
  resolveNsemclawPackageRootSync: vi.fn(() => null),
}));
...
let openclawRoot: typeof import("./nsemclaw-root.js");
...
describe("control UI assets helpers (fs-mocked)", () => {
  beforeAll(async () => {
    ...
    openclawRoot = await import("./nsemclaw-root.js");
  });
  ...
  it("uses resolveNsemclawPackageRoot when available", async () => {
    const pkgRoot = abs("fixtures/openclaw");
    (
      openclawRoot.resolveNsemclawPackageRoot as unknown as ReturnType<typeof vi.fn>
  ...
  it("resolves control-ui root for dist bundle argv1 and moduleUrl candidates", async () => {
    ...
    (
      openclawRoot.resolveNsemclawPackageRootSync as unknown as ReturnType<typeof vi.fn>
