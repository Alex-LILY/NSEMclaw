...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["NSEMCLAW_STATE_DIR", "NODE_ENV", "VITEST"]);
    process.env.NSEMCLAW_STATE_DIR = tempDir;
    ...
    if (!loaded) {
      ({ resolveNsemclawPackageRoot } = await import("./nsemclaw-root.js"));
  ...
  function mockPackageUpdateStatus(tag = "latest", version = "2.0.0") {
    vi.mocked(resolveNsemclawPackageRoot).mockResolvedValue("/opt/openclaw");
