...
export const A2UI_PATH = "/__nsemclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__nsemclaw__/canvas";

export const CANVAS_WS_PATH = "/__nsemclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.nsemclawCanvasA2UIAction.postMessage(...)
  // - Android: window.nsemclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["nsemclawCanvasA2UIAction"];
  ...
  globalThis.Nsemclaw = globalThis.Nsemclaw ?? {};
  globalThis.Nsemclaw.postMessage = postToNode;
  globalThis.Nsemclaw.sendUserAction = sendUserAction;
  globalThis.nsemclawPostMessage = postToNode;
  globalThis.nsemclawSendUserAction = sendUserAction;
