...
import { type NsemclawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: NsemclawConfig): string[] {
...
export function listAgentsForGateway(cfg: NsemclawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: NsemclawConfig): string {
...
function resolveSessionStoreAgentId(cfg: NsemclawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: NsemclawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: NsemclawConfig): GatewaySessionsDefaults {
