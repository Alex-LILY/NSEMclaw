...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.NSEMCLAW_STATE_DIR;
  const configPath = env.NSEMCLAW_CONFIG_PATH;
  ...
  return {
    ...
    NSEMCLAW_PROFILE: profile,
    NSEMCLAW_STATE_DIR: stateDir,
    NSEMCLAW_CONFIG_PATH: configPath,
    NSEMCLAW_GATEWAY_PORT: String(port),
    NSEMCLAW_GATEWAY_TOKEN: token,
    NSEMCLAW_LAUNCHD_LABEL: resolvedLaunchdLabel,
    NSEMCLAW_SYSTEMD_UNIT: systemdUnit,
    NSEMCLAW_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    NSEMCLAW_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    NSEMCLAW_STATE_DIR: stateDir,
    NSEMCLAW_CONFIG_PATH: configPath,
    NSEMCLAW_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    NSEMCLAW_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    NSEMCLAW_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    NSEMCLAW_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    NSEMCLAW_LOG_PREFIX: "node",
    NSEMCLAW_SERVICE_MARKER: NODE_SERVICE_MARKER,
    NSEMCLAW_SERVICE_KIND: NODE_SERVICE_KIND,
    NSEMCLAW_SERVICE_VERSION: VERSION,
  };
}
