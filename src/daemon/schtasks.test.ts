  ...
  it.each([
    {
      ...
      expected: path.join("C:\\Users\\test", ".nsemclaw", "gateway.cmd"),
    },
    {
      ...
      expected: path.join("C:\\Users\\test", ".nsemclaw-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers NSEMCLAW_STATE_DIR over profile-derived defaults",
      env: {
        USERPROFILE: "C:\\Users\\test",
        OPENCLAW_PROFILE: "rescue",
        NSEMCLAW_STATE_DIR: "C:\\State\\openclaw",
      },
    ...
    },
    {
      ...
      expected: path.join("/home/test", ".nsemclaw", "gateway.cmd"),
    },
  ])("$name", ({ env, expected }) => {
...
describe("readScheduledTaskCommand", () => {
  ...
  it("reads script from NSEMCLAW_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ NSEMCLAW_STATE_DIR: path.join(tmpDir, "custom-state") }),
