...
const SETUP_TOKEN_RAW = process.env.NSEMCLAW_LIVE_SETUP_TOKEN?.trim() ?? "";
const SETUP_TOKEN_VALUE = process.env.NSEMCLAW_LIVE_SETUP_TOKEN_VALUE?.trim() ?? "";
const SETUP_TOKEN_PROFILE = process.env.NSEMCLAW_LIVE_SETUP_TOKEN_PROFILE?.trim() ?? "";
const SETUP_TOKEN_MODEL = process.env.NSEMCLAW_LIVE_SETUP_TOKEN_MODEL?.trim() ?? "";
  ...
  it(
    ...
    async () => {
      ...
      try {
        ...
        await ensureNsemclawModelsJson(cfg, tokenSource.agentDir);
