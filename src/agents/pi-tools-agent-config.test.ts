...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: NsemclawConfig) {
    return createNsemclawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<NsemclawConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<NsemclawConfig["agents"]>["list"]>[number]["tools"];
  }): NsemclawConfig {
    return {
      tools: params.tools,
      agents: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createNsemclawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createNsemclawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createNsemclawCodingTools({
      config: cfg,
    ...
    const defaultTools = createNsemclawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createNsemclawCodingTools({
      config: cfg,
    ...
    const bobTools = createNsemclawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createNsemclawCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createNsemclawCodingTools({
      config: cfg,
