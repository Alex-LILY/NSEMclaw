...
function resolveAdaptiveReadMaxBytes(options?: NsemclawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createNsemclawReadTool(base, {
...
export function createNsemclawReadTool(
  base: AnyAgentTool,
  options?: NsemclawReadToolOptions,
): AnyAgentTool {
