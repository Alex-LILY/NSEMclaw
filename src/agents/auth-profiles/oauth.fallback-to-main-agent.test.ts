...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveNsemclawAgentDir() returns mainAgentDir
    process.env.NSEMCLAW_STATE_DIR = tmpDir;
    process.env.NSEMCLAW_AGENT_DIR = mainAgentDir;
