...
export const DEFAULT_SANDBOX_IMAGE = "nsemclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "nsemclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "nsemclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "nsemclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "nsemclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "nsemclaw-sandbox-browser";
