...
const CLEANUP_STATE_KEY = Symbol.for("nsemclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("nsemclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("nsemclaw.sessionWriteLockWatchdogState");
