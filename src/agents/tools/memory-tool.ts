...
function resolveMemoryToolContext(options: { config?: NsemclawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: NsemclawConfig): MemoryCitationsMode {
