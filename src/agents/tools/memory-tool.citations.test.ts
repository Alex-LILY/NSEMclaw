...
function asNsemclawConfig(config: Partial<NsemclawConfig>): NsemclawConfig {
  return config as NsemclawConfig;
}

function createToolConfig() {
  return asNsemclawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: NsemclawConfig = createToolConfig()) {
