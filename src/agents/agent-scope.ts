...
type AgentEntry = NonNullable<NonNullable<NsemclawConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: NsemclawConfig): AgentEntry[] {
...
export function listAgentIds(cfg: NsemclawConfig): string[] {
...
export function resolveDefaultAgentId(cfg: NsemclawConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: NsemclawConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: NsemclawConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: NsemclawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: NsemclawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
