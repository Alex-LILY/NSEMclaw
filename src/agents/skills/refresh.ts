...
function resolveWatchPaths(workspaceDir: string, config?: NsemclawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: NsemclawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: NsemclawConfig }) {
