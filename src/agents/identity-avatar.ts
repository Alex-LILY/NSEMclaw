...
function resolveAvatarSource(cfg: NsemclawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: NsemclawConfig, agentId: string): AgentAvatarResolution {
