...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: NsemclawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: NsemclawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: NsemclawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: NsemclawConfig }): Promise<void> {
