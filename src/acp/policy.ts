...
export function isAcpEnabledByPolicy(cfg: NsemclawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: NsemclawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: NsemclawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: NsemclawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: NsemclawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: NsemclawConfig, agentId: string): boolean {
