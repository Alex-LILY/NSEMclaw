    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["nsemclaw directory self --channel slack", "Show the connected account identity."],
          [
            'nsemclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["nsemclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "nsemclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.nsemclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
