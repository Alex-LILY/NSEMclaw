...
describe("registerSubCliCommands", () => {
  ...
  const originalDisableLazySubcommands = process.env.NSEMCLAW_DISABLE_LAZY_SUBCOMMANDS;
  ...
  beforeEach(() => {
    if (originalDisableLazySubcommands === undefined) {
      delete process.env.NSEMCLAW_DISABLE_LAZY_SUBCOMMANDS;
    } else {
      process.env.NSEMCLAW_DISABLE_LAZY_SUBCOMMANDS = originalDisableLazySubcommands;
    }
