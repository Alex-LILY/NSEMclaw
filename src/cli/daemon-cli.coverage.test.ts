...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.NSEMCLAW_STATE_DIR = "/tmp/openclaw-cli-state";
    process.env.NSEMCLAW_CONFIG_PATH = "/tmp/openclaw-cli-state/nsemclaw.json";
    delete process.env.NSEMCLAW_GATEWAY_PORT;
    delete process.env.NSEMCLAW_PROFILE;
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        NSEMCLAW_STATE_DIR: "/tmp/openclaw-daemon-state",
        NSEMCLAW_CONFIG_PATH: "/tmp/openclaw-daemon-state/nsemclaw.json",
