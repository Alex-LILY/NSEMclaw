const DEFAULT_TAGLINE = "巫山神女，记忆如行云流水。All your memory, one NSEM·瑶姬。";
...
const TAGLINES: string[] = [
  ...
  "The only goddess in your contacts who remembers everything. ✨",
  "Neural-symbolic memory, wrapped in divine grace.",
  "Because Siri wasn't answering at 3AM.",
  "巫山云雨，皆入记忆长存。",
  "瑶姬不语，却记得你所有代码的变迁。",
  "神经符号记忆，神女之智。",
  "行云流水中，长存万千记忆。",
  "不是魔法，是 Neural-Symbolic Episodic Memory。",
  "Your terminal now has a goddess with perfect memory.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.NSEMCLAW_TAGLINE_INDEX;
