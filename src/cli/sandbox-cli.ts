...
const SANDBOX_EXAMPLES = {
  main: [
    ["nsemclaw sandbox list", "List all sandbox containers."],
    ["nsemclaw sandbox list --browser", "List only browser containers."],
    ["nsemclaw sandbox recreate --all", "Recreate all containers."],
    ["nsemclaw sandbox recreate --session main", "Recreate a specific session."],
    ["nsemclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["nsemclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["nsemclaw sandbox list", "List all sandbox containers."],
    ["nsemclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["nsemclaw sandbox recreate --all", "Recreate all containers."],
    ["nsemclaw sandbox recreate --session main", "Recreate a specific session."],
    ["nsemclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["nsemclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["nsemclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["nsemclaw sandbox explain", "Show effective sandbox config."],
    ["nsemclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["nsemclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["nsemclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.nsemclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
