...
type SecretDefaults = NonNullable<NsemclawConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: NsemclawConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveNsemclawAgentDir()));
