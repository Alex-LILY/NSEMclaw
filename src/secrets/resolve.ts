...
function resolveResolutionLimits(config: NsemclawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: NsemclawConfig): SecretProviderConfig {
