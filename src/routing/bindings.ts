...
export function listBindings(cfg: NsemclawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: NsemclawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: NsemclawConfig) {
