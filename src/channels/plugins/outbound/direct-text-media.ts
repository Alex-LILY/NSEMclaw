...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: NsemclawConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: NsemclawConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "signal") {
  return (params: { cfg: NsemclawConfig; accountId?: string | null }) =>
