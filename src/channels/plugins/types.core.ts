...
export type ChannelAgentToolFactory = (params: { cfg?: NsemclawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NsemclawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: NsemclawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: NsemclawConfig }) => boolean;
  supportsCards?: (params: { cfg: NsemclawConfig }) => boolean;
