...
import { discoverNsemclawPlugins } from "../../plugins/discovery.js";
import type { NsemclawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, NsemclawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["NSEMCLAW_PLUGIN_CATALOG_PATHS", "NSEMCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<NsemclawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: NsemclawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: NsemclawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverNsemclawPlugins({ workspaceDir: options.workspaceDir });
