...
export function listChannelMessageActions(cfg: NsemclawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: NsemclawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: NsemclawConfig): boolean {
