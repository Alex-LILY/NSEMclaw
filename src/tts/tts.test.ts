...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.NSEMCLAW_TTS_PREFS;
      process.env.NSEMCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.NSEMCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: NsemclawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
