...
const ensureNsemclawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveNsemclawAgentDir = vi.fn().mockReturnValue("/tmp/openclaw-agent");
...
vi.mock("../agents/models-config.js", () => ({
  ensureNsemclawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveNsemclawAgentDir,
}));
