...
export function applyOpencodeZenProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyOpencodeZenConfig(cfg: NsemclawConfig): NsemclawConfig {
