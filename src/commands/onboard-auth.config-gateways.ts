...
export function applyVercelAiGatewayProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyVercelAiGatewayConfig(cfg: NsemclawConfig): NsemclawConfig {
