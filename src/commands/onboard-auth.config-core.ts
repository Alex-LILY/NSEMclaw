...
export function applyOpenrouterProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: NsemclawConfig): NsemclawConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyMoonshotConfig(cfg: NsemclawConfig): NsemclawConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: NsemclawConfig): NsemclawConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: NsemclawConfig): NsemclawConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: NsemclawConfig): NsemclawConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: NsemclawConfig): NsemclawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: NsemclawConfig): NsemclawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: NsemclawConfig): NsemclawConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: NsemclawConfig): NsemclawConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: NsemclawConfig): NsemclawConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: NsemclawConfig): NsemclawConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyQianfanProviderConfig(cfg: NsemclawConfig): NsemclawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: NsemclawConfig): NsemclawConfig {
