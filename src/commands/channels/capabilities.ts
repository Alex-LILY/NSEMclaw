...
// NOTE: Discord target helpers are not available - commented out
// type DiscordTargetSummary = { raw: string; normalized?: string; kind?: string; channelId?: string };
// function parseDiscordTarget(raw: string, _opts?: { defaultKind?: string }): { kind: string; id: string; normalized: string } | null { return null; }
