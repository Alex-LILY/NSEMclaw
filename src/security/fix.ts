...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof NsemclawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: NsemclawConfig; env: NodeJS.ProcessEnv }): {
  cfg: NsemclawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
