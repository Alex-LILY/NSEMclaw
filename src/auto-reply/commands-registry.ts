...
export function isCommandEnabled(cfg: NsemclawConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: NsemclawConfig): {
  provider: string;
  model: string;
} {
  const resolved = resolveConfiguredModelRef({
    cfg: cfg ?? ({} as NsemclawConfig),
...
export function getCommandDetection(_cfg?: NsemclawConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: NsemclawConfig) {
