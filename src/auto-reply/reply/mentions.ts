...
function resolveMentionPatterns(cfg: NsemclawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: NsemclawConfig | undefined, agentId?: string): RegExp[] {
