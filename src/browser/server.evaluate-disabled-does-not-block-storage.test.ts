...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.NSEMCLAW_GATEWAY_PORT;
    process.env.NSEMCLAW_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.NSEMCLAW_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.NSEMCLAW_GATEWAY_PASSWORD;
