...
describe("chrome extension relay server", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.NSEMCLAW_EXTENSION_RELAY_RECONNECT_GRACE_MS;
    delete process.env.NSEMCLAW_EXTENSION_RELAY_COMMAND_RECONNECT_WAIT_MS;
  });
  ...
  it("closes CDP clients after reconnect grace when extension stays disconnected", async () => {
    process.env.NSEMCLAW_EXTENSION_RELAY_RECONNECT_GRACE_MS = "150";
