...
function resolveGatewayPort(cfg: NsemclawConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: NsemclawConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.NSEMCLAW_GATEWAY_PASSWORD?.trim() ||
