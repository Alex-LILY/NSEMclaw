...
const loadNsemclawPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadNsemclawPlugins: (params: unknown) => loadNsemclawPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadNsemclawPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadNsemclawPluginsMock.mockClear();
  });
