...
export type NsemclawPluginConfigSchema = {
...
export type NsemclawPluginToolContext = {
...
export type NsemclawPluginToolFactory = (
  ctx: NsemclawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type NsemclawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type NsemclawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<NsemclawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type NsemclawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current Nsemclaw configuration */
  config: NsemclawConfig;
 ...
 */
export type NsemclawPluginCommandDefinition = {
...
export type NsemclawPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type NsemclawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type NsemclawPluginCliContext = {
  program: Command;
  config: NsemclawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type NsemclawPluginCliRegistrar = (ctx: NsemclawPluginCliContext) => void | Promise<void>;

export type NsemclawPluginServiceContext = {
  config: NsemclawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type NsemclawPluginService = {
  id: string;
  start: (ctx: NsemclawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: NsemclawPluginServiceContext) => void | Promise<void>;
};

export type NsemclawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type NsemclawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: NsemclawPluginConfigSchema;
  register?: (api: NsemclawPluginApi) => void | Promise<void>;
  activate?: (api: NsemclawPluginApi) => void | Promise<void>;
};

export type NsemclawPluginModule =
  | NsemclawPluginDefinition
  | ((api: NsemclawPluginApi) => void | Promise<void>);

export type NsemclawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | NsemclawPluginToolFactory,
    opts?: NsemclawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: NsemclawPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: NsemclawPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: NsemclawPluginHttpRouteHandler }) => void;
  registerChannel: (registration: NsemclawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: NsemclawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: NsemclawPluginService) => void;
   ...
   */
  registerCommand: (command: NsemclawPluginCommandDefinition) => void;
