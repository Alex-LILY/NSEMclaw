...
export const PLUGIN_MANIFEST_FILENAME = "nsemclaw.plugin.json";
...
// package.json "nsemclaw" metadata (used for onboarding/catalog)
...
export type NsemclawPackageManifest = {
  extensions?: string[];
...
): NsemclawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
