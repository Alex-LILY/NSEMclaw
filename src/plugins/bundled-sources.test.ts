...
const discoverNsemclawPluginsMock = vi.fn();
const loadPluginManifestMock = vi.fn();

vi.mock("./discovery.js", () => ({
  discoverNsemclawPlugins: (...args: unknown[]) => discoverNsemclawPluginsMock(...args),
}));
...
describe("bundled plugin sources", () => {
  beforeEach(() => {
    discoverNsemclawPluginsMock.mockReset();
    loadPluginManifestMock.mockReset();
  });

  it("resolves bundled sources keyed by plugin id", () => {
    discoverNsemclawPluginsMock.mockReturnValue({
      candidates: [
        {
          origin: "global",
