  ...
  .object({
    ...
    nsem: z
      .object({
        enabled: z.boolean().optional(),
        resourceMode: z
          .union([z.literal("minimal"), z.literal("balanced"), z.literal("performance")])
          .optional(),
        evolutionIntervalMinutes: z.number().int().positive().optional(),
        maxAtoms: z.number().int().positive().optional(),
        ingestConversations: z.boolean().optional(),
