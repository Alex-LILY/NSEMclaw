...
function resolveAnthropicDefaultAuthMode(cfg: NsemclawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyTalkApiKey(config: NsemclawConfig): NsemclawConfig {
...
export function applyTalkConfigNormalization(config: NsemclawConfig): NsemclawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: NsemclawConfig): NsemclawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyLoggingDefaults(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyContextPruningDefaults(cfg: NsemclawConfig): NsemclawConfig {
...
export function applyCompactionDefaults(cfg: NsemclawConfig): NsemclawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
