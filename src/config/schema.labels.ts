export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.nsem": "NSEM Memory",
  "agents.defaults.nsem.enabled": "Enable NSEM",
  "agents.defaults.nsem.resourceMode": "NSEM Resource Mode",
  "agents.defaults.nsem.evolutionIntervalMinutes": "NSEM Evolution Interval (minutes)",
  "agents.defaults.nsem.maxAtoms": "NSEM Max Atoms",
  "agents.defaults.nsem.ingestConversations": "NSEM Ingest Conversations",
  "agents.defaults.nsem.rerankerModel": "NSEM Reranker Model",
  "agents.defaults.nsem.expansionModel": "NSEM Expansion Model",
  memory: "Memory",
