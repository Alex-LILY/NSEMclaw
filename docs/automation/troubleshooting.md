...
nsemclaw system heartbeat last
nsemclaw logs --follow
nsemclaw config get agents.defaults.heartbeat
nsemclaw channels status --probe
```
...
```bash
nsemclaw config get agents.defaults.heartbeat.activeHours
nsemclaw config get agents.defaults.heartbeat.activeHours.timezone
nsemclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
nsemclaw cron list
nsemclaw logs --follow
```
