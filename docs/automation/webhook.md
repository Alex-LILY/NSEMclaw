...
read_when:
  ...
  - Wiring external systems into Nsemclaw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Nsemclaw config directory (typically `~/.nsemclaw/hooks/transforms`).
...
- `nsemclaw webhooks gmail setup` writes `hooks.gmail` config for `nsemclaw webhooks gmail run`.
