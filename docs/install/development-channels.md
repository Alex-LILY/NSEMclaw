...
Nsemclaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Nsemclaw also aligns
the install method:
...
When you switch channels with `nsemclaw update`, Nsemclaw also syncs plugin sources:
