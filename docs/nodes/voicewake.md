...
Nsemclaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.nsemclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["nsemclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
