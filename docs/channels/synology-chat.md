---
summary: "Synology Chat webhook setup and Nsemclaw config"
read_when:
  - Setting up Synology Chat with Nsemclaw
...
```bash
nsemclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Nsemclaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Nsemclaw.
...
- Pairing approvals work with:
  - `nsemclaw pairing list synology-chat`
  - `nsemclaw pairing approve synology-chat <CODE>`
...
```bash
nsemclaw message send --channel synology-chat --target 123456 --text "Hello from Nsemclaw"
nsemclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
