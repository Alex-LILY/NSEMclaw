...
- Install via CLI: `nsemclaw plugins install @nsemclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `nsemclaw plugins install ./extensions/zalo`
   - From npm (if published): `nsemclaw plugins install @nsemclaw/zalo`
...
- Approve via:
  - `nsemclaw pairing list zalo`
  - `nsemclaw pairing approve zalo <CODE>`
...
- Example: `nsemclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `nsemclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `nsemclaw logs --follow`
