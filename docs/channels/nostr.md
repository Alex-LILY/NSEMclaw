...
read_when:
  - You want Nsemclaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Nsemclaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`nsemclaw onboard`) and `nsemclaw channels add` list optional channel plugins.
...
```bash
nsemclaw plugins install @nsemclaw/nostr
```

Use a local checkout (dev workflows):

```bash
nsemclaw plugins install --link <path-to-nsemclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "nsemclaw",
        "displayName": "Nsemclaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "nsemclaw@example.com",
        "lud16": "nsemclaw@example.com"
      }
    }
  }
}
