...
read_when:
  ...
  - Reviewing Nsemclaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is Nsemclaw’s explicit **owner approval** step.
...
Stored under `~/.nsemclaw/credentials/`:
...
3. On your phone, open the Nsemclaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `nsemclaw nodes pending/approve`) is a
