---
summary: "Overview of Nsemclaw onboarding options and flows"
read_when:
...
Nsemclaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`nsemclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the Nsemclaw app when you want a fully guided setup on macOS. Docs:
