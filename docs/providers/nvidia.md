---
summary: "Use NVIDIA's OpenAI-compatible API in Nsemclaw"
read_when:
  - You want to use NVIDIA models in Nsemclaw
...
nsemclaw onboard --auth-choice skip
nsemclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
