---
summary: "Use Qwen OAuth (free tier) in Nsemclaw"
read_when:
  - You want to use Qwen with Nsemclaw
...
If you already logged in with the Qwen Code CLI, Nsemclaw will sync credentials
