---
summary: "Use Qianfan's unified API to access many models in Nsemclaw"
read_when:
...
3. Nsemclaw installed on your system
...
4. Copy the API key for use with Nsemclaw

## CLI setup

```bash
nsemclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Nsemclaw Configuration](/gateway/configuration)
