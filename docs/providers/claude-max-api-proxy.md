...
You can point Nsemclaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Nsemclaw
...
- [Anthropic provider](/providers/anthropic) - Native Nsemclaw integration with Claude setup-token or API keys
