---
summary: "Use Synthetic's Anthropic-compatible API in Nsemclaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Nsemclaw registers it as the
...
Note: Nsemclaw's Anthropic client appends `/v1` to the base URL, so use
