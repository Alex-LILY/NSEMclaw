---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Nsemclaw"
read_when:
  - You want Xiaomi MiMo models in Nsemclaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Nsemclaw uses
