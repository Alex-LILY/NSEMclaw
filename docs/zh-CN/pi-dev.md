...
本指南总结了在 Nsemclaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 Nsemclaw 状态目录下。默认为 `~/.nsemclaw`。如果设置了 `NSEMCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.nsemclaw.ai/testing
- https://docs.nsemclaw.ai/start/getting-started
