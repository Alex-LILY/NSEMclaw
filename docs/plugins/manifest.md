...
read_when:
  - You are building a Nsemclaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (nsemclaw.plugin.json)

Every plugin **must** ship a `nsemclaw.plugin.json` file in the **plugin root**.
Nsemclaw uses this manifest to validate configuration **without executing plugin
