...
read_when:
  - You want to publish a third-party Nsemclaw plugin
...
This page tracks high-quality **community-maintained plugins** for Nsemclaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `nsemclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `nsemclaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Nsemclaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/nsemclaw-wechat`
  repo: `https://github.com/icesword0760/nsemclaw-wechat`
  install: `nsemclaw plugins install @icesword760/nsemclaw-wechat`
