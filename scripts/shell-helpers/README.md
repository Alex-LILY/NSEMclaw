...
Inspired by Simon Willison's [Running Nsemclaw in Docker](https://til.simonwillison.net/llms/nsemclaw-docker).
...
- Checks common paths (`~/nsemclaw`, `~/workspace/nsemclaw`, etc.)
...
```bash
nsemclaw channels login --channel whatsapp --verbose
```
