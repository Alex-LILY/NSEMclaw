...
export function listZalouserAccountIds(cfg: NsemclawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: NsemclawConfig): string {
...
function mergeZalouserAccountConfig(cfg: NsemclawConfig, accountId: string): ZalouserAccountConfig {
