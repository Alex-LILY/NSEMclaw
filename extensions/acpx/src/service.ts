...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "nsemclaw/plugin-sdk";
import {
  ACPX_PINNED_VERSION,
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: NsemclawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: NsemclawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
