...
import type { ReplyPayload, NsemclawConfig } from "nsemclaw/plugin-sdk";
import { createReplyPrefixOptions } from "nsemclaw/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as NsemclawConfig;
