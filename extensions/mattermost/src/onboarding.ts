import type { ChannelOnboardingAdapter, NsemclawConfig, WizardPrompter } from "nsemclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.nsemclaw.ai/channels/mattermost",
    ].join("\n"),
