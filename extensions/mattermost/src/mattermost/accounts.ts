...
export function listMattermostAccountIds(cfg: NsemclawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: NsemclawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: NsemclawConfig): ResolvedMattermostAccount[] {
