...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "nsemclaw/plugin-sdk";
...
import { resolvePreferredNsemclawTmpDir } from "../../../src/infra/tmp-nsemclaw-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredNsemclawTmpDir(), "msteams-mention-"));
