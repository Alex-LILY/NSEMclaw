...
export const SUPPORTED_LOCALES: ReadonlyArray<Locale> = ["zh-CN", "zh-TW"];
...
class I18nManager {
  ...
  private resolveInitialLocale(): Locale {
    const saved = localStorage.getItem("nsemclaw.i18n.locale");
  ...
  public async setLocale(locale: Locale) {
    ...
    this.locale = locale;
    localStorage.setItem("nsemclaw.i18n.locale", locale);
    this.notify();
  }
