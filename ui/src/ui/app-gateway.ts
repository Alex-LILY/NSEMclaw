...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "nsemclaw-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as NsemclawApp);
      void loadAgents(host as unknown as NsemclawApp);
      void loadToolsCatalog(host as unknown as NsemclawApp);
      void loadNodes(host as unknown as NsemclawApp, { quiet: true });
      void loadDevices(host as unknown as NsemclawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as NsemclawApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as NsemclawApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as NsemclawApp);
  }
}
