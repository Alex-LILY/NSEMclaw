    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
      <div class="usage-header-row">
        ...
        <div class="usage-header-metrics">
          ...
          >
            ${props.headerPinned ? t("common.pinned") : t("common.pin")}
          </button>
          <details
          ...
          >
            <summary class="usage-export-button">${t("common.export")} ▾</summary>
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `nsemclaw-usage-sessions-${exportStamp}.csv`,
                ...
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `nsemclaw-usage-daily-${exportStamp}.csv`,
                ...
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `nsemclaw-usage-${exportStamp}.json`,
                      JSON.stringify(
                        {
          ...
          <div class="usage-query-actions">
            ...
            ${
              hasDraftQuery || hasQuery
                ? html`<button class="btn btn-sm usage-action-btn usage-secondary-btn" @click=${props.onClearQuery}>${t("common.clear")}</button>`
                : nothing
            }
            <span class="usage-query-hint">
              ${
                hasQuery
                  ? t("usage.matches", {
                      filtered: String(filteredSessions.length),
                      total: String(totalSessions),
                    })
                  : t("usage.totalInRange", { total: String(totalSessions) })
              }
            </span>
          </div>
        </div>
