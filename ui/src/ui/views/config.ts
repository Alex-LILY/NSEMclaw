                  ...
                  <span class="config-changes-badge"
                    >${
                      props.formMode === "raw"
                        ...
                        : t("config.viewPendingChanges").replace("{count}", String(diff.length))
                    }</span
                  >
                `
                : html`
            ...
            ? html`
              <details class="config-diff">
                <summary class="config-diff__summary">
                  <span>${t("config.viewPendingChanges").replace("{count}", String(diff.length))}</span
                  >
                  <svg
