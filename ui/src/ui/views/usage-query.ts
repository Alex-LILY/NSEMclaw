...
const buildSessionsCsv = (sessions: UsageSessionEntry[]): string => {
  const rows = [
    toCsvRow([
      ...
      t("usage.csv.agentId"),
      t("usage.csv.channel"),
      t("usage.csv.provider"),
      t("usage.csv.model"),
      t("usage.csv.updatedAt"),
      t("usage.csv.durationMs"),
      t("usage.csv.messages"),
      t("usage.csv.errors"),
      t("usage.csv.toolCalls"),
      t("usage.csv.inputTokens"),
      t("usage.csv.outputTokens"),
      t("usage.csv.cacheReadTokens"),
      t("usage.csv.cacheWriteTokens"),
      t("usage.csv.totalTokens"),
      t("usage.csv.totalCost"),
    ]),
  ];
...
const buildDailyCsv = (daily: CostDailyEntry[]): string => {
  const rows = [
    toCsvRow([
      ...
      t("usage.csv.cacheWriteTokens"),
      t("usage.csv.totalTokens"),
      t("usage.csv.inputCost"),
      t("usage.csv.outputCost"),
      t("usage.csv.cacheReadCost"),
      t("usage.csv.cacheWriteCost"),
      t("usage.csv.totalCost"),
    ]),
  ];
