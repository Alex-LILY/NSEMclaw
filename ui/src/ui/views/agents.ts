...
function renderAgentHeader(
  ...
  const subtitle = agent.identity?.theme?.trim() || t("agents.workspaceAndRouting");
    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${skillFilter ? `${skillCount} ${t("common.selected")}` : t("agents.allSkills")}</div>
        </div>
      </div>
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        ...
        <div class="row" style="gap: 12px; flex-wrap: wrap;">
          <label class="field" style="min-width: 260px; flex: 1;">
            <span>${t("agents.primaryModel")}${isDefault ? ` (${t("common.default")})` : ""}</span>
            <select
