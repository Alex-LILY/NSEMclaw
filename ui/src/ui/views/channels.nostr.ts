...
export function renderNostrCard(params: {
          ...
          hasAnyProfileData
            ? html`
              <div class="status-list">
                ...
                ${name ? html`<div><span class="label">${t("common.name")}</span><span>${name}</span></div>` : nothing}
                ${
                  displayName
  ...
  return html`
    <div class="card">
      ...
      <div class="card-sub">${t("channels.nostr.description")}</div>
      ${accountCountLabel}
