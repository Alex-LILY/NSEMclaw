  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        ...
        <div style="font-size: 12px; color: var(--text-muted);">${t("channels.nostr.account")}: ${accountId}</div>
      </div>
        ...
        state.showAdvanced
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--text-muted);">${t("common.advanced")}</div>
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t("common.saving") : t("channels.nostr.saveAndPublish")}
        </button>
        ...
        >
          ${state.importing ? t("channels.nostr.importing") : t("channels.nostr.importFromRelays")}
        </button>
        ...
        isDirty
          ? html`
              <div style="font-size: 12px; color: var(--warning-color); margin-top: 8px">
                ${t("channels.nostr.unsavedChanges")}
              </div>
            `
          : nothing
      }
