  ...
  return html`
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          <div class="label">${t("common.default")}</div>
...
export function renderAgentChannels(params: {
  ...
  return html`
    <section class="grid grid-cols-2">
      ${renderAgentContextCard(params.context, t("agents.contextSubtitle"))}
      <section class="card">
                ...
                <div class="list" style="margin-top: 16px;">
                  ${entries.map((entry) => {
                    ...
                    const status = summary.total
                      ? `${summary.connected}/${summary.total} ${t("agents.connected")}`
                      : t("agents.noAccounts");
                    const config = summary.configured
                      ? `${summary.configured} ${t("agents.configured")}`
                      : t("agents.notConfigured");
                    const enabled = summary.total
                      ? `${summary.enabled} ${t("common.enabled")}`
                      : t("common.disabled");
...
export function renderAgentCron(params: {
  ...
  return html`
    <section class="grid grid-cols-2">
      ${renderAgentContextCard(params.context, t("agents.cronSubtitle"))}
      <section class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            <div class="stat-label">${t("cron.summary.jobs")}</div>
            <div class="stat-value">${params.status?.jobs ?? "n/a"}</div>
          </div>
          <div class="stat">
            <div class="stat-label">${t("cron.summary.nextWake")}</div>
              ...
              <div class="agent-files-grid" style="margin-top: 16px;">
                ...
                <div class="agent-files-editor">
                  ${
                    !activeEntry
                      ? html`
                          <div class="muted">${t("agents.selectFileToEdit")}</div>
                        `
                      : html`
